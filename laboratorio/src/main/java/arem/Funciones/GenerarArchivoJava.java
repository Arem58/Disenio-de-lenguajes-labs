...
public class GenerarArchivoJava {
    ...
    public static void generarArchivoJava(String mapFileName) {
        ...
        try {
            ...
            archivo.write("            if (!dictionaryTokens.values().contains(token)){ \n");
            ...
            archivo.write("                 gas.SLR1(); \n");
            archivo.write("            } catch(Exception e){ \n");
            archivo.write("                 System.err.println(\"Ha ocurrido un error durante la ejecución. El programa se cerrará.\"); \n");
            archivo.write("                 System.exit(1); \n");
            archivo.write("            } \n");
            archivo.write("        } \n");
            archivo.write("    }\n\n");
